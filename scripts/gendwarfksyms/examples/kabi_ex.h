 ...
 * data_member_location(0) , STABLE-NEXT:   member base_type [[ULONG:long
 * unsigned int|unsigned long]] byte_size(8) encoding(7) data_member_location(8)
 * , STABLE-NEXT:   member base_type [[ULONG]] byte_size(8) encoding(7)
 * data_member_location(16) STABLE-NEXT: } byte_size(24)
 */
 ...
 * STABLE-NEXT:   member base_type int byte_size(4) encoding(5) a
 * data_member_location(0) , STABLE-NEXT:   member base_type [[ULONG]]
 * byte_size(8) encoding(7) data_member_location(8) , STABLE-NEXT:   member
 * base_type [[ULONG]] byte_size(8) encoding(7) data_member_location(16)
 ...
 * STABLE-NEXT:   member base_type unsigned int byte_size(4) encoding(7) a
 * data_member_location(0) , STABLE-NEXT:   member array_type[64] { STABLE-NEXT:
 * base_type unsigned char byte_size(1) encoding(8) STABLE-NEXT:   }
 * data_member_location(8) STABLE-NEXT: } byte_size(72)
 */
 ...
 * STABLE-NEXT:   member base_type int byte_size(4) encoding(5) a
 * data_member_location(0) , STABLE-NEXT:   member base_type [[ULONG]]
 * byte_size(8) encoding(7) b data_member_location(8) STABLE-NEXT:   member
 * base_type int byte_size(4) encoding(5) c data_member_location(16) ,
 * STABLE-NEXT:   member base_type [[ULONG]] byte_size(8) encoding(7) d
 * data_member_location(24) STABLE-NEXT: } byte_size(32)
 */
...
_Static_assert(sizeof(struct ex2a) == sizeof(struct ex2b),
               "ex2a size doesn't match ex2b");
...
_Static_assert(sizeof(struct ex2a) == sizeof(struct ex2c),
               "ex2a size doesn't match ex2c");
 ...
 * STABLE-NEXT:   member base_type [[ULONG]] byte_size(8) encoding(7) a
 * data_member_location(0) STABLE-NEXT:   member base_type [[ULONG]]
 * byte_size(8) encoding(7) unused data_member_location(8) STABLE-NEXT: }
 * byte_size(16)
 */
...
_Static_assert(sizeof(struct ex3a) == sizeof(struct ex3b),
               "ex3a size doesn't match ex3b");
...
_Static_assert(sizeof(struct ex3a) == sizeof(struct ex3c),
               "ex3a size doesn't match ex3c");
 ...
 * STABLE-NEXT:   member base_type [[ULONG]] byte_size(8) encoding(7) a
 * data_member_location(0) STABLE-NEXT: } byte_size(8)
 */
...
KABI_TYPE_STRING("s#ex5a",
                 "structure_type ex5a { member pointer_type { s#ex4a } "
                 "byte_size(8) p data_member_location(0) } byte_size(8)");
 ...
 * VERSIONS-SAME:       member base_type [[ULONG:long unsigned int|unsigned
 * long]] byte_size(8) encoding(7) a data_member_location(0) VERSIONS-SAME: }
 * byte_size(8) VERSIONS-SAME:   } byte_size(8) p data_member_location(0)
...
KABI_TYPE_STRING("s#ex5b",
                 "structure_type ex5b { member pointer_type { s#ex5c } "
                 "byte_size(8) p data_member_location(0) } byte_size(8)");

/* Define a type string for a non-existent struct ex5c */
KABI_TYPE_STRING("s#ex5c",
                 "structure_type ex5c { member base_type int byte_size(4) "
                 "encoding(5) n data_member_location(0) } byte_size(8)");
 ...
 * VERSIONS-SAME:       member base_type int byte_size(4) encoding(5) n
 * data_member_location(0) VERSIONS-SAME:     } byte_size(8) VERSIONS-SAME:   }
 * byte_size(8) p data_member_location(0) VERSIONS-SAME: } byte_size(8)
 */
 ...
 * VERSIONS-SAME:   member base_type int byte_size(4) encoding(5) n
 * data_member_location(0) VERSIONS-SAME: } byte_size(8)
 */
#endif /* __KABI_EX_H__ */
