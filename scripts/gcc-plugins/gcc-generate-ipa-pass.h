...
#else
#define __READ_OPTIMIZATION_SUMMARY(n)                                         \
  _GCC_PLUGIN_CONCAT2(n, _read_optimization_summary)
...
#else
#define __WRITE_OPTIMIZATION_SUMMARY(n)                                        \
  _GCC_PLUGIN_CONCAT2(n, _write_optimization_summary)
...
public:
  _PASS_NAME_PASS()
      : ipa_opt_pass_d(_PASS_NAME_PASS_DATA, g, _GENERATE_SUMMARY,
                       _WRITE_SUMMARY, _READ_SUMMARY,
                       _WRITE_OPTIMIZATION_SUMMARY, _READ_OPTIMIZATION_SUMMARY,
                       _STMT_FIXUP, FUNCTION_TRANSFORM_TODO_FLAGS_START,
                       _FUNCTION_TRANSFORM, _VARIABLE_TRANSFORM) {}
